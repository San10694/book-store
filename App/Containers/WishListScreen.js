...
import { TouchableOpacity, StyleSheet, Text, View, FlatList, ScrollView, Image, Alert } from "react-native";
                                        ...
                                        onPress={() => {
                                            Alert.alert(
                                                ...
                                                [
                                                    ...
                                                    { text: 'OK', onPress: () => this.props.removeWishListItem(item.product) },
                                                ],
                                                { cancelable: false }
                                            );
