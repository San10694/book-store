...
export default {
    ...
    advrContainer: { bottom: 17, right: 7, position: 'absolute', flexDirection: 'row', paddingRight: 30 },
    ...
    headText: { fontSize: Fonts.size.h6, paddingLeft: 20 },
    ...
    categoryContainer: { position: 'absolute', top: 15, right: 7, paddingRight: 20, paddingTop: 5, flexDirection: 'row' },
